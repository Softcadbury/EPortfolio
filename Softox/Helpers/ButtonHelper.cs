...
namespace Softox.Helpers
{
    public class ButtonHelper
    {
        ...
        public static string TestButton(string link)
        {
            return String.Format(" <a class='btn btn-success' href='{0}' target='_blank'>Tester</a>", link);
        }

        public static string TestFreeButton(string link)
        {
        ...
        public static string ImageButton(string folder, int num, string tilte = "")
        {
            ...
            return String.Format(@"
                <div class='col-lg-3'><a class='fancybox' rel=""{0}"" href='{1}.jpg' title=""{2}"">
